...
#SOLUTION WILL DETERMINE THE PATH WITH MINIMUM RANGER TRAVEL TIME!
...
def MinTime(startNode, endNode):
    ...
    RangerMinTimeTravelQuery =  crocDF.loc[crocDF.query('RangerSpeed>0').index]
    RangerMinTimeTravelQuery2=  RangerMinTimeTravelQuery.loc[RangerMinTimeTravelQuery.query('RangerSpeed>0').index]
    print("---RANGER SPEED MINIMUM---")
    print(RangerMinTimeTravelQuery2.to_string())
...
def MinTimeBruteForce():
    ...
    print("---RANGER SPEED MINIMUM---")
    print(RangerMinTimeTravelQuery.to_string())
