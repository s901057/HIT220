...
#Route_exists(point_a: location, point_b: location) ->exists:Boolean
...
# load the croc DATA
df  = pd.read_excel(r'C:\temp\CrocDataLatest.xls', sheet_name='Nodes')
...
#brute force saerch ON 32 NODES
def Route_exists_Brute_Force():
    countA = 33
    countB = 33
    while countA > 0 :
        countB = 33
        while countB > 0:
            if countA==countB:
                break
            print('Route ' + str(countA) + 'to ' + str(countB) + ' PATH'+ str(Route_exists(g,countA,countB)))
           # if Route_exists(g,countA,countB)==True:
           #     print('Route '+str(countA) + 'to '+str(countB) + 'Exists')
           # else:
           #     print('Route '+str(countA) + 'to '+str(countB) + ' NOT Exists')
            countB=countB-1
...
if Route_exists(g,1,3)==True:
    print('Route Exists')
else:
    print('Route NOT Exists')

Route_exists_Brute_Force()
